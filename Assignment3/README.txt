...
1. Download the three input files from canvas into the same directory as you plan to put the program

2. Use putty to open csx3.cs.okstate.edu machine

3. Download all .java files into a the same directory as the .txt files from canvas
