...
public class AdjacencyMapGraph<V,E> implements Graph<V,E> {
  ...
  public void removeEdge(Edge<E> e) throws IllegalArgumentException {
    ...
    Vertex<V> endPoint1 = edge.getEndpoints()[0];
    Vertex<V> endPoint2 = edge.getEndpoints()[1];
    InnerVertex<V> vert1 = (InnerVertex<V>) endPoint1;
    InnerVertex<V> vert2 = (InnerVertex<V>) endPoint2;
    // InnerVertex<V>[] verts = (InnerVertex<V>[]) edge.getEndpoints(); // Did not work. 
